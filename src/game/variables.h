...
MACRO_CONFIG_STR(SvGametype, sv_gametype, 32, "idm", CFGFLAG_SERVER, "Game type (idm, itdm, ictf, ilms, isur)")
...
MACRO_CONFIG_INT(SvWeapon, sv_weapon, 4, 0, 5, CFGFLAG_SERVER, "The weapon to spawn with.")
